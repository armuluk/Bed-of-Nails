...
you have <?php echo $op1bit7; ?> OR <?php echo $op2bit7; ?>.</p>
...
<tr>
  ...
  <td <?php if ($op1bit7 == 1 & $op2bit7 == 0) {echo 'class="selected"';} ?> >1</td>
</tr>
<tr>
  <th <?php if ($op2bit7 == 1) {echo 'class="selected"';} ?> >1</th>
  <td <?php if ($op1bit7 == 0 & $op2bit7 == 1) {echo 'class="selected"';} ?> >1</td>
  <td <?php if ($op1bit7 == 1 & $op2bit7 == 1) {echo 'class="selected"';} ?> >1</td>
</tr>
</table>

<p>So <?php echo $op1bit7; ?> OR <?php echo $op2bit7; ?> = <?php echo $resultBit7; ?>, 
...
<p>We see that the second column has <?php echo $op1bit6; ?> OR <?php echo $op2bit6; ?>. From the truth table:</p>
...
<tr>
  ...
  <td <?php if ($op1bit6 == 1 & $op2bit6 == 0) {echo 'class="selected"';} ?> >1</td>
</tr>
<tr>
  <th <?php if ($op2bit6 == 1) {echo 'class="selected"';} ?> >1</th>
  <td <?php if ($op1bit6 == 0 & $op2bit6 == 1) {echo 'class="selected"';} ?> >1</td>
  <td <?php if ($op1bit6 == 1 & $op2bit6 == 1) {echo 'class="selected"';} ?> >1</td>
</tr>
</table>

<p>So <?php echo $op1bit6; ?> OR <?php echo $op2bit6; ?> = <?php echo $resultBit6; ?>, 
