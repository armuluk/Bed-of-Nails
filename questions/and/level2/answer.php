...
you have <?php echo $bit1A; ?> AND <?php echo $bit2A; ?>.</p>
...
<tr>
  ...
  <td <?php if ($bit1A == 1 & $bit2A == 0) {echo 'class="selected"';} ?> >0</td>
</tr>
<tr>
  <th <?php if ($bit2A == 1) {echo 'class="selected"';} ?> >1</th>
  <td <?php if ($bit1A == 0 & $bit2A == 1) {echo 'class="selected"';} ?> >0</td>
  <td <?php if ($bit1A == 1 & $bit2A == 1) {echo 'class="selected"';} ?> >1</td>
</tr>
</table>

<p>So <?php echo $bit1A; ?> AND <?php echo $bit2A; ?> = <?php echo $resultA; ?>, 
...
<p>The second column has <?php echo $bit1B; ?> AND <?php echo $bit2B; ?>. From the truth table:</p>
...
<tr>
  ...
  <td <?php if ($bit1B == 1 & $bit2B == 0) {echo 'class="selected"';} ?> >0</td>
</tr>
<tr>
  <th <?php if ($bit2B == 1) {echo 'class="selected"';} ?> >1</th>
  <td <?php if ($bit1B == 0 & $bit2B == 1) {echo 'class="selected"';} ?> >0</td>
  <td <?php if ($bit1B == 1 & $bit2B == 1) {echo 'class="selected"';} ?> >1</td>
</tr>
</table>

<p>So <?php echo $bit1B; ?> AND <?php echo $bit2B; ?> = <?php echo $resultB; ?>, 
