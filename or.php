...
if ($_SESSION['PERSISTtopic'] != 2) {
  $_SESSION['PERSISTtopic'] = 2;	//OR
...
$answerPath = "questions\\or\\level" . $level . "\\";
$generatorPath = "questions\\or\\level" . $level . "\\";
$errorResponsePath = "questions\\or\\level" . $level . "\\";
$errorResponseFiles = array("hint1.php", "hint2.php", "answer.php");
$correctResponsePath = "questions\\or\\";
